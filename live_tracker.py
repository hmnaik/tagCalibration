...
from aruco_utils import ArucoInitializer, CameraConfig, VisualizationUtils, TrajectoryIO
...
class LiveArucoTracker:
    ...
    def save_trajectory(self, output_path):
        ...
        """
        saved = TrajectoryIO.save_trajectory(self.trajectory_data, output_path)
        if saved:
